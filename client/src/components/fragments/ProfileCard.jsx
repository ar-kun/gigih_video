...
export const ProfileCard = ({ showModalChannel, dataChannel, setShowModalChannel, channelTitle }) => {
 const createMarkup = () => ({ __html: dataChannel.channelDescription.replace(/\n\n/g, '<br /><br />').replace(/\n/g, '<br />') });
   ...
   {showModalChannel ? (
    <>
     <div className="justify-center items-center flex fixed inset-0 z-50 outline-none focus:outline-none">
      <div className="relative  w-auto my-6 mx-auto rounded-lg max-w-3xl h-3/4 overflow-y-scroll">
       <Button
